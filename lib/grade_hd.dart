...
import 'choose_grade_hd.dart';
import 'student.dart';

class GradeHd extends StatefulWidget
{
  GradeHd({Key key, this.week}) : super(key: key);

  final String week;

  @override
  _GradeHdState createState() => _GradeHdState();
}


class _GradeHdState extends State<GradeHd>
{
  @override
                      ...
                      //     student.image) : null,
                        ...
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(
                              builder: (context) {
                                return ChooseGradeHd(id: student.id, week: widget.week,);
                              }));
                        }
                    );
                  },
